...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvArticleHeadLine = view.findViewById(R.id.textv_article_headline);
        tvArticleDate = view.findViewById(R.id.textv_article_date);
        tvArticleAuthor = view.findViewById(R.id.textv_article_author);
        tvArticleText = view.findViewById(R.id.textv_article_text);
        ivArticleImage = view.findViewById(R.id.imagev_article_img);
        tvArticleCount = view.findViewById(R.id.textv_article_count);
